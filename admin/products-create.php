...
if(isset($_POST['add_product'])){
   ...
   if($select_products->rowCount() > 0){
      ...
      $insert_products = $conn->prepare("INSERT INTO `products`(name, details, price, category, image_01, artists, artist_details) VALUES(?,?,?,?,?,?)");
      $insert_products->execute([$name, $details, $price, $category, $image_01, $artists, $artist_details]);
