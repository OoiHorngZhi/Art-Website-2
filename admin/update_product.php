...
if(isset($_POST['update'])){
   ...
   $update_product = $conn->prepare("UPDATE `products` SET name = ?, price = ?, category = ?, details = ?, artists = ?, artist_details = ? WHERE id = ?");
   $update_product->execute([$name, $price, $category, $details, $artists, $artist_details, $pid]);
