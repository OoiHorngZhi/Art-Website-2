...
<section class="checkout-orders">
   ...
   <h3>your orders</h3>
      ...
      <div class="flex">
         <div class="inputBox">
            <span>your name :</span>
            <input type="text" name="name" placeholder="enter your name" class="box" maxlength="20" value="<?= $fetch_profile["name"]; ?>" required>
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            ...
            <input type="email" name="email" placeholder="enter your email" class="box" value="<?= $fetch_profile["email"]; ?>" maxlength="50" required>
         </div>
         <div class="inputBox">
